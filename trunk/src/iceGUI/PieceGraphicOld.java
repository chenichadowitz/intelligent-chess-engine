...
public class PieceGraphicOld {
	 ...
	 */
	public static PieceGraphicOld makePieceGraphic(BoardArea ba, Piece p){
		int[] xy = new int[2];
		...
		if(p.getColor()){
			switch(p.type()){
				case 'K':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/whiteKing.png")), xy, p);
				case 'Q':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/whiteQueen.png")), xy, p);
				case 'R':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/whiteRook.png")), xy, p);
				case 'B':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/whiteBishop.png")), xy, p);
				case 'N':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/whiteKnight.png")), xy, p);
				case 'P':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/whitePawn.png")), xy, p);
			}
		} else {
			switch(p.type()){
				case 'K':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/blackKing.png")), xy, p);
				case 'Q':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/blackQueen.png")), xy, p);
				case 'R':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/blackRook.png")), xy, p);
				case 'B':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/blackBishop.png")), xy, p);
				case 'N':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/blackKnight.png")), xy, p);
				case 'P':
					return new PieceGraphicOld(new ImageIcon(cldr.getResource("resources/images/blackPawn.png")), xy, p);
			}
		}
		return null;
	}
	 ...
	 */
	private PieceGraphicOld(ImageIcon orig, int x, int y, Piece p){
		DEFAULT_IMG = orig;
		boardCoord[0] = x;
		boardCoord[1] = y;
		pc = p;
	 ...
	 * @param p Piece that this is linked to
	 */
	private PieceGraphicOld(ImageIcon orig, int[] xy, Piece p){
